...
namespace AuthGG
{
    ...
    internal class OnProgramStart
    {
        ...
        public static void Initialize(string name, string aid, string secret, string version)
        {
            ...
            {
                MessageBox.Show("Failed to initialize your application correctly in Program.cs!", Name);
    ...
    internal class API
    {
        ...
        public static void UploadPic(string username, string path)
        {
            ...
            {
                MessageBox.Show("Invalid Picture information!", ApplicationSettings.Name);
                Process.GetCurrentProcess().Kill();
            }
            string[] response = new string[] { };
            using (WebClient wc = new WebClient())
            {
                ...
                try
                {
                    ...
                    {
                        case "success":
                            MessageBox.Show("Successfully updated profile picture!", OnProgramStart.Name);
                            Security.End();
                            return;
                        case "permissions":
                            MessageBox.Show("Please upgrade your plan to use this feature!", OnProgramStart.Name);
                            Security.End();
                            return;
                        case "failed":
                            MessageBox.Show("Failed to upload profile picture!", OnProgramStart.Name);
                            Security.End();
                            return;
                    }
                }
